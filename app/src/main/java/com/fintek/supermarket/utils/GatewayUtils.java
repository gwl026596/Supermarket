...
public class GatewayUtils {
                ...
                while (ias.hasMoreElements()) {
                    ...
                    if (vpn) {
                        ...
                        if (!ia.isLoopbackAddress() && !ia.isSiteLocalAddress()) {
                            map.put("vpn", TextUtils.isEmpty(ia.getHostAddress()) ? Constant.UNKNOWN : ia.getHostAddress());
                        } else if (!ia.isLoopbackAddress() && ia.isSiteLocalAddress()) {
                            map.put("en0", TextUtils.isEmpty(ia.getHostAddress()) ? Constant.UNKNOWN : ia.getHostAddress());
                            map.put("network_name", TextUtils.isEmpty(ni.getName()) ? Constant.UNKNOWN : ni.getName());
                        }
                    } else {
                        // vpn 关闭，数据流量
    ...
    public static String getMacAddress(Context context) {
        String macAddress = Constant.UNKNOWN;
